...
export const hw2CsrRankGuideEl = document.getElementById('hw2-csr-rank-guide') as HTMLElement | null;
export const hw2ReturnToSearchWrapEl = document.getElementById('hw2-return-to-search-wrap') as HTMLElement | null;
