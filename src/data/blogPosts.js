...
const blogPosts = [
  {
    ...
    excerpt: "From DreamWorks and Spielberg through EA LA and Danger Close, why Warfighter shelved the series, what VR’s Above and Beyond signals, and where the back catalogue is playable today.",
  ...
  },
  {
    ...
    tags: ["Sniper Elite"],
    readingTimeMinutes: 5,
    excerpt: "Notes from the first campaign mission on PC (medium): third-person pacing, subsonic ammo, traversal, traps, Fleck cannons, dam objectives, and classic Sniper Elite kill-cam feedback.",
  ...
  },
  {
    ...
    excerpt: "Companion notes to the video: Red Team’s role and lore, Forge’s arc and sacrifice, Anders and Cutter, Serena’s six years alone and rampancy—and why the Spirit of Fire crew stops a Covenant Forerunner gambit decades before Halo CE.",
  ...
  },
  {
    ...
    tags: ["Crackdown"],
    readingTimeMinutes: 5,
    excerpt: "From Crackdown 1’s Halo 3 beta tailwind and co-op sandbox to Crackdown 2’s freak outbreak, Crackdown 3’s cloud-destruction pivot—and whether Microsoft might revisit the series.",
  ...
  },
  {
    ...
    excerpt: "Install the C&C Online launcher, use Hook to enable your game, launch from Origin or Steam, then sign in and host a Custom Match lobby for multiplayer.",
  ...
  },
  {
    ...
    excerpt: "This is my beginner-friendly walkthrough of relics in Age of Mythology: Retold: how they differ from other Age games, what you need to use them, how I scout and prioritize them, and where the UI still makes things harder on console.",
  ...
  },
  {
    ...
    excerpt: "Blur is framed as a standout Xbox 360 / PS3–era arcade combat racer from Activision and Bizarre Creations: power-up heavy, aggressive, and often described as “Mario Kart for adults” (with the joke that adults play Mario Kart anyway).",
  ...
  },
  {
    ...
    excerpt: "The video treats Call of Duty: Roads to Victory as a curiosity: a World War II–era CoD built for the PSP when the brand was still strongly associated with WWII, months before the franchise’s modern pivot with Call of Duty 4.",
  ...
  },
  {
    ...
    readingTimeMinutes: 5,
    excerpt: "PlayStation trophies versus Xbox achievements: tiers, Platinums, DLC lists, profile levels — and why raw Gamerscore often fails to tell a story.",
  ...
  },
  {
    ...
    readingTimeMinutes: 4,
    excerpt: "My love letter to the classic RollerCoaster Tycoon line: late-90s PC success, Chris Sawyer’s one-developer craft, OpenRCT2 and RCT3, and why sandbox plus management still resonates with me.",
  ...
  },
  {
    ...
    excerpt: "How Ensemble Studios designed Halo Wars around a controller-only platform — unit selection, locked base slots, and maps built for fixed bases — and why that blueprint still defines console RTS.",
  ...
  },
  {
    ...
    category: "Retro",
    tags: ["Army of Two"],
    excerpt: "Co-op, aggro, three releases in five years, preservation headaches on modern Xbox, and why a remaster might be the path back.",
  ...
  },
  {
    ...
    tags: ["Halo Wars 2"],
    excerpt: "Complete walkthrough for Operation Spearbreaker DLC in Halo Wars 2. Covers strategies, unit usage, and mission objectives for both missions on Heroic difficulty.",
  ...
  },
  {
    ...
    excerpt: "Andy and Gus tackle the full Halo Infinite campaign on Legendary in co-op — completing the Storehaus run through mainline Halo (except Halo 5), ~8.5 hours, linear missions plus Zeta Halo sandbox, and mixed verdicts on campaign vs. open world.",
  ...
  },
  {
    ...
    tags: ["Halo FPS"],
    readingTimeMinutes: 8,
    excerpt: "Legendary co-op playthrough of Halo Reach in MCC—mission-by-mission notes from Andy and Gus, plus overall campaign takeaways.",
  ...
  },
  {
    ...
    tags: ["Halo Wars 1"],
    featured: true,
    excerpt: "A complete co-op Legendary walkthrough of the Halo Wars Definitive Edition campaign. Mission highlights, skull and black box locations, co-op tips, and unit priorities for every mission.",
  ...
  },
  {
    ...
    category: "Reviews",
    tags: ["Halo Wars 2"],
    excerpt: "A comprehensive review of Halo Wars 2 after playing for over 1,000 hours. Discover the pros, cons, and whether this RTS is worth your time in 2026.",
  ...
  },
  {
    ...
    category: "Reviews",
    tags: ["Halo Wars 2"],
    excerpt: "Annual leader tier list for 2026. A subjective ranking of all Halo Wars 2 leaders from S-tier powerhouses like Atriox and Colony to the situational picks.",
  ...
  },
  {
    ...
    category: "Reviews",
    tags: ["Halo Wars 2"],
    excerpt: "A comprehensive tier list ranking of all multiplayer maps in Halo Wars 2, from S-tier Sentry to F-tier Fort Jordan. Includes Blitz and Terminus Firefight maps.",
  ...
  },
  {
    ...
    category: "Reviews",
    tags: ["Halo Wars 2"],
    excerpt: "A comprehensive review of Terminus Firefight mode in Halo Wars 2. Discover the strategic depth, leader synergies, and what makes this mode worth playing.",
  ...
  },
  {
    ...
    category: "Reviews",
    tags: ["Halo Wars 2"],
    excerpt: "A subjective ranking of the top 10 active UNSC leader powers in Halo Wars 2. From Johnson's Bunker to Ghost in the Machine, discover which powers dominate the battlefield.",
  ...
  },
  {
    ...
    tags: ["Halo Wars 2"],
    featured: false,
    excerpt: "Complete guide to all 15 skulls in Halo Wars 2 campaign. Learn how to unlock each skull, their effects, and detailed strategies for finding them in every mission.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Halo Wars 2"],
    excerpt: "Discover the most effective leaders for Terminus Firefight mode in Halo Wars 2. Learn the best 3v3 combinations, top tier leaders like Johnson and Pavium, and key strategies for survival.",
  ...
  },
  {
    ...
    category: "Reviews",
    tags: ["Halo Wars 2"],
    excerpt: "A subjective ranking of the top 10 active Banished leader powers in Halo Wars 2. From Grunt Dome to Cataclysm, discover which powers dominate the battlefield.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Halo Wars 2"],
    excerpt: "New to Halo Wars 2? Learn the basics with these ten essential tips to get you started on the battlefield!",
  ...
  },
  {
    ...
    excerpt: "Learn the basics of Age of Empires IV with these essential tips!",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Halo Wars 2"],
    excerpt: "This is a Halo Wars 2 tutorial I put together on advanced movement: chaining orders, hold position, control groups, splitting when a beam (or similar power) hits, and squeezing information out of fog of war.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Age of Mythology"],
    excerpt: "A guide for the Atlantean civilization in Age of Mythology.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Age of Mythology"],
    excerpt: "This is a beginner-oriented walkthrough of the Egyptians in Age of Mythology: Retold: how their economy differs from other civs, how pharaoh and priest work, how favor from monuments shapes their game, and how their military scales from the barracks into stronghold cavalry and siege.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Age of Mythology"],
    excerpt: "Beginner walkthrough for Greeks in Age of Mythology Retold on Xbox/controller: economy, temple and aging, defense, myth units, trade, and Titans—controller shortcuts where they matter.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Halo Wars 2"],
    excerpt: "Learn how to break the super turtle in Halo Wars 2.",
  ...
  },
  {
    ...
    readingTimeMinutes: 5,
    excerpt: "Learn how to get maximum villager efficiency in Age of Empires II.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Halo Wars 2"],
    excerpt: "Learn how to play as Atriox in Halo Wars 2.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Halo Wars 2"],
    excerpt: "Learn how to play as Captain Cutter in Halo Wars 2.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Halo Wars 2"],
    excerpt: "Learn how to play as Colony in Halo Wars 2.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Halo Wars 2"],
    excerpt: "Learn how to play as Kinsano in Halo Wars 2.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Halo Wars 2"],
    excerpt: "Learn how to play as Pavium in Halo Wars 2.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Halo Wars 2"],
    excerpt: "Learn how to play as Sgt. Forge in Halo Wars 2.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Halo Wars 2"],
    excerpt: "Learn how to play as The Banished in Halo Wars 2.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Halo Wars 2"],
    excerpt: "Learn how to play as UNSC in Halo Wars 2.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Halo Wars 2"],
    excerpt: "Learn how to play as Voridus in Halo Wars 2.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Halo Wars 2"],
    excerpt: "Learn how to play as Yap Yap in Halo Wars 2.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Halo Wars 2"],
    excerpt: "Learn how to stop air spam in Halo Wars 2.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Age of Empires IV"],
    excerpt: "Learn how to play the Nomad Megarandom game mode in Age of Empires IV.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Age of Empires II"],
    excerpt: "Villagers, aging up, when to add military, proxy and castle drops, starter counters, and trading — a beginner loop for Age of Empires II from Jimbo, Gus, and Andy.",
  ...
  },
  {
    ...
    readingTimeMinutes: 3,
    featured: true,
    excerpt: "A short, dense skill guide for Age of Mythology: Retold—economy, relics, military production, water, civ adaptation, trade, TCs, upgrades, scouting, and learning habits.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Age of Mythology"],
    excerpt: "New to Age of Mythology on PS5? Learn the basics of using the controller and the fundamentals of the game.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Age of Mythology"],
    excerpt: "Learn the basics of Age of Mythology on Xbox with these essential tips!",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Age of Mythology"],
    excerpt: "Understand the basics of defensive play in Age of Mythology.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Halo Wars 1"],
    excerpt: "Learn how to beat the most difficult mission in Halo Wars.",
  ...
  },
  {
    ...
    tags: ["Halo Wars 1"],
    readingTimeMinutes: 4,
    excerpt: "Scarab mission tips for Halo Wars (original): pylons, Scorpions and Wolverines, Forge and MAC, reading the beam, and closing on the core.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Age of Empires II"],
    excerpt: "Follow-up to basic movement for AoE2 DE on Xbox: chaining villager orders, control groups and production buildings, the Find menu, forward proxy bases, flares, and fast minimap camera moves.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Age of Empires II"],
    excerpt: "Walkthrough-style breakdown of getting moving in Age of Empires II: DE on Xbox: villagers, priority presets, early resources, aging up, and controller basics (radial menus, attack move, rally points).",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Age of Empires IV"],
    excerpt: "A comprehensive guide for new players to the world of Age of Empires IV, covering civilizations, resources, and combat. This guide is for the Xbox version of the game.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Age of Empires IV"],
    excerpt: "A guide for using an Xbox controller in Age of Empires IV. This guide is for the Xbox version of the game.",
  ...
  },
  {
    ...
    category: "Guides",
    tags: ["Halo Wars 2"],
    excerpt: "Learn how to master Professor Anders in Halo Wars 2. This beginner's guide covers her strengths with Sentinels and siege gameplay, build orders, and key strategies.",
  ...
  },
  {
    ...
    tags: ["Halo Wars 2"],
    featured: false,
    excerpt: "Master the art of super turtling in Halo Wars 2. Learn the best maps, leaders like Pavium and Serina, build orders, and defensive strategies.",
