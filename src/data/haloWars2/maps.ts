...
export const mapData: Record<string, HaloMap> = {
  'skirmish\\design\\fort_jordan\\fort_jordan': {
    ...
    cloudinaryId: 'team-respawn-website/maps/placeholder/fort-jordan',
  },
  'rostermode\\design\\RM_EvenFlowNight\\RM_EvenFlowNight': {
    ...
    cloudinaryId: 'team-respawn-website/maps/placeholder/nocturne',
  },
  'rostermode\\design\\RM_EvenFlow_Desert\\RM_EvenFlow_Desert': {
    ...
    cloudinaryId: 'team-respawn-website/maps/placeholder/sirocco',
  },
  'skirmish\\design\\Ep02_M03\\Ep02_M03': {
    ...
    cloudinaryId: 'team-respawn-website/maps/placeholder/fissures',
  },
  'skirmish\\design\\MC_EnforcerValley\\MC_EnforcerValley': {
    ...
    cloudinaryId: 'HW2_Artwork_Mirage_wl3str',
  },
  'skirmish\\design\\FF_StopTheSignal\\FF_StopTheSignal': {
    ...
    cloudinaryId: 'team-respawn-website/maps/placeholder/high-bastion',
  },
  'skirmish\\design\\MP_Eagle\\MP_Eagle': {
    id: 'skirmish\\design\\MP_Eagle\\MP_Eagle',
    name: 'Badlands',
    imageUrl: 'https://content.halocdn.com/media/Default/games/halo-wars-2/maps/map-badlands-fa971bd11a1742a9b12ea48f9923bd8a.jpg',
    cloudinaryId: 'team-respawn-website/maps/placeholder/badlands',
  },
  'skirmish\\design\\MP_Bridges\\MP_Bridges': {
    ...
    cloudinaryId: 'team-respawn-website/maps/placeholder/frontier',
  },
  'skirmish\\design\\MP_Razorblade\\MP_Razorblade': {
    ...
    cloudinaryId: 'HW2_Artwork_Bedrock_smcmyj',
  },
  'skirmish\\design\\MP_Ricochet\\MP_Ricochet': {
    ...
    cloudinaryId: 'HW2_Artwork_Sentry_fclq8w',
  },
  'skirmish\\design\\MP_Caldera\\MP_Caldera': {
    ...
    cloudinaryId: 'HW2_Artwork_Ashes_x6eytx',
  },
  'skirmish\\design\\MP_Boneyard\\MP_Boneyard': {
    ...
    cloudinaryId: 'HW2-Highway_sbbmzn',
  },
  'skirmish\\design\\MP_Veteran\\MP_Veteran': {
    ...
    cloudinaryId: 'team-respawn-website/maps/placeholder/vault',
  },
  'rostermode\\design\\RM_EvenFlowArt\\RM_EvenFlowArt': {
    ...
    cloudinaryId: 'team-respawn-website/maps/placeholder/the-proving-grounds',
  },
  'skirmish\\design\\MP_Fracture\\MP_Fracture': {
    ...
    cloudinaryId: 'team-respawn-website/maps/placeholder/rift',
  },
};
...
function buildCloudinaryUploadUrl(publicId?: string): string {
  if (!CLOUDINARY_CLOUD_NAME || !publicId) return '';
  return `https://res.cloudinary.com/${CLOUDINARY_CLOUD_NAME}/image/upload/${CLOUDINARY_TRANSFORMS}/${publicId}`;
}
...
export function getMapImage(mapId: string): string {
  ...
  if (!map) return '';
  if (map.cloudinaryUrl) return map.cloudinaryUrl;
  if (map.cloudinaryId) {
    const cloudinary = buildCloudinaryUploadUrl(map.cloudinaryId);
    if (cloudinary) return cloudinary;
  }
  const fallback = map.imageUrl || '';
  if (CLOUDINARY_CLOUD_NAME && fallback) {
    const cloudinaryFetch = buildCloudinaryFetchUrl(fallback);
    if (cloudinaryFetch) return cloudinaryFetch;
  }
  return fallback;
}
